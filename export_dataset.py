...
gripper_list = ['heph_new']#['panda','kinova','robotiq2f140','robotiq2f85','robotiq3f','shadowhand'] # #,
dino_layer = cfg.dino_layer
uni3d_layer = cfg.uni3d_layer
for gripper in gripper_list:
    save_features(f'/home/data/tianshuwu/data/ref_960/{gripper}', dino_layer, device,use_3d_feature=True,get_2d_feature=True, uni3d_layer =uni3d_layer,uni3d_use_color=uni3d_use_color)
# for gripper in gripper_list:
